...
4.请根据您申请模板中定义的项目，以及项目中的角色更新[openEuler.yaml]()
...
+ 对于重大变更或可能影响其他项目组的任何变更（例如范围变更），请填写PR申请，并将该申请发送给技术委员会，发送主题请标注成“SIG章程更新：*YOURSIG*”
+ 对于影响范围小的变更，比如只影响本SIG范围内的问题或领域，SIG的Mainatiner可以自行协助进行变更



##  项目章程批准流程

引入新SIG或对老SIG的章程进行修改时，过程如下：

+ 从SIG中确定推动变更的负责人，最常见的就是SIG的Mainatiner作为负责人
...
+ 对于较大的变更，确认变更范围后请通知openEuler社区内受到影响的其他SIG组，并将邮件发送到tsc@openEuler.org，或者在社区门户上宣布。

如果这一过程中有任何疑问，请联系技术委员会：tsc@openEuler.org
...
如果孵化类项目希望自己的交付件可以进入**社区发行光盘**，请先向社区申请项目毕业

1.将[模板](template-gradudate.md)复制到community/proj*YOURPROJECT*/graduate.md
...
6.技术委员会通常会在发送申请后的一周内反馈。如果遇到假期或重要会议等因素，可能会需要更长时间。在此期间，您可以进行任何有需要的更改

7.技术委员会将通过合并Pull Request的方式来批准您的项目毕业申请
